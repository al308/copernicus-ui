...
AS $$
DECLARE
  project_url TEXT := 'https://joxzelcwedebjmpcofde.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpveHplbGN3ZWRlYmptcGNvZmRlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczOTUzNTU3MywiZXhwIjoyMDU1MTExNTczfQ.CtjFFnB_CZWN2vNNNhVXIOkF6h_FOVXIjPThAFeS6u8'; -- full access needed for http request to storage
